...
Class Translation
{
    ...
    public function translate($text, $targetLang = 'en', $sourceLang = 'ru', $isHtml = false){
    ...
    public function languages(){
        $arLanguages = $this->query("https://translate.api.cloud.yandex.net/translate/v2/languages");
        return $arLanguages;
    }
}